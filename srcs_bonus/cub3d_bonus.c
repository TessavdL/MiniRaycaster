...
/*                                                   +#+                      */
/*   Created: 2021/07/23 13:28:04 by tevan-de      #+#    #+#                 */
/*   Updated: 2022/02/16 14:02:31 by tevan-de      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static void	initialize_cub3d(t_data *data, int bmp)
{
	...
	set_wall_textures(data->parser.texture, data->paint.texture,
		data->mlx.mlx);
	set_sprite_texture(data->parser.texture[5], &data->sprite.texture,
		data->mlx.mlx);
}

void	cub3d(t_data data, int bmp)
{
	initialize_cub3d(&data, bmp);
	raycasting(data);
	if (bmp == 1)
