...
/*   Updated: 2022/02/25 14:41:06 by tevan-de      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
// static long int	ft_atoi_pointer_continued(char **str, int sign)
// {
// 	unsigned long int	number;
...
// 	if (ft_isdigit(**str) == 0)
// 		return (-1);
// 	return (ft_atoi_pointer_continued(str, sign));
// }
