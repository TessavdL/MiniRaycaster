...
#    Updated: 2022/02/28 13:00:19 by tevan-de      ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
if [ ! -f "../cub3D" ]; then
    ...
    printf "\n${CYAN}Test ${TNUM}/28: < 0 ceiling colour values${RESET}\n"
    cd ..; ./cub3D cub3d_tester_bonus/maps/col_inv.cub
    ((TNUM+=1))
    printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    read -s -n 1 KEY
    if [$KEY == ""] ; then
        printf "\n${CYAN}Test ${TNUM}/28: > 255 ceiling colour value${RESET}\n"
        ./cub3D cub3d_tester_bonus/maps/col_inv2.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/col_inv3.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/col_inv4.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/col_inv5.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    read -s -n 1 KEY
    if [$KEY == ""] ; then
        printf "\n${CYAN}Test ${TNUM}/28: valid 0,0,0 ceiling colour${RESET}\n"
        ./cub3D cub3d_tester_bonus/maps/col_valid0.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/dir_dup.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/dir_inv.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/dir_none.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/tex_dup.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/tex_inv.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/tex_invfile.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/tex_miss.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/tex_space.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/map_nl.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/map_none.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/map_open.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/map_opensp.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/map_opendir.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/map_opendiag.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/map_sprite.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/map_openvalid.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/res_overfl.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/res_big.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/res_big.cub --save
        ((TNUM+=1))
        BMP=$(ls -t *.bmp | head -1)
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/res_inv2.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    if [$KEY == ""] ; then
        ...
        ./cub3D cub3d_tester_bonus/maps/res_inv.cub
        ((TNUM+=1))
        printf "\n${BLUEBG}${WHITE}Press ENTER for next test${RESET}\n"
    else
        printf "Exiting test\n"
    ...
    ./cub3D cub3d_tester_bonus/maps/folder.cub
    ((TNUM+=1))
    fi
fi